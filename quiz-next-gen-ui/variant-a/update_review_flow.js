...
const newReviewHtml = `<!-- Screen: Exam Review Flow -->
        <div id="view-exam-review" class="quiz-view" style="background: #f8fafc;">
            ...
            <div class="view-content" style="padding-top: 16px; padding-bottom: 120px; background: #f8fafc;">
                ...
                <div id="review-question-container" style="background: white; border-radius: 16px; padding: 24px; border: 1.5px solid rgba(15,23,42,0.04); margin-bottom: 24px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.02);">
                    ...
                    <h3 id="review-q-text" style="font-size: 17px; font-weight: 600; color: #0f172a; margin: 0 0 24px 0; line-height: 1.6;">
                        <!-- Question Text -->
                    </h3>
        ...
        <script>
            ...
            function openExamReview(element) {
                ...
                const scoreEl = element.querySelector('span[style*="font-weight: 800"]');
            ...
            function renderReviewQuestion() {
                ...
                q.options.forEach((opt, idx) => {
                    ...
                    let icon = '<div style="width: 24px; height: 24px; border-radius: 50%; border: 1.5px solid #cbd5e1;"></div>';
                    
                    if (opt.isCorrect) {
                        bg = '#ecfdf5';
                        border = '1.5px solid #10b981';
                        icon = '<div style="width: 24px; height: 24px; border-radius: 50%; background: #10b981; color: white; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: bold;">✓</div>';
                    } else if (idx === q.userSelectedIndex) {
                        // User selected this but it's wrong
                        bg = '#fef2f2';
                        border = '1.5px solid #ef4444';
                        icon = '<div style="width: 24px; height: 24px; border-radius: 50%; background: #ef4444; color: white; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: bold;">✗</div>';
                    }

                    optDiv.style = \`padding: 16px 20px; border-radius: 14px; background: \${bg}; border: \${border}; display: flex; gap: 14px; align-items: flex-start;\`;
                    
                    optDiv.innerHTML = \`
                        \${icon}
                        <div style="font-size: 15px; font-weight: 600; color: #0f172a; line-height: 1.5; padding-top: 2px;">\${opt.text}</div>
                    \`;
