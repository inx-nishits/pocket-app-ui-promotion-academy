...
if (sergeantStart !== -1 && mixedCardStart !== -1) {
    const newExams = `
            ...
            <div class="format-card" onclick="QuizEngine.startFlow('topic')" style="align-items: flex-start;">
                <div class="format-card-left" style="align-items: flex-start;">
                    ...
                    <div class="format-info" style="width: 100%;">
                        <h3 style="font-size: 18px; margin-bottom: 8px;">Sergeant Promotion Exam (NPPF Step 2)</h3>
            ...
            <div class="format-card" onclick="QuizEngine.startFlow('topic')" style="align-items: flex-start;">
                <div class="format-card-left" style="align-items: flex-start;">
                    ...
                    <div class="format-info" style="width: 100%;">
                        <h3 style="font-size: 18px; margin-bottom: 8px;">Inspector Promotion Exam (NPPF Step 2)</h3>
                        <div style="display: flex; gap: 8px; margin-bottom: 0; flex-wrap: wrap;">
                            <span style="font-size: 12px; font-weight: 600; color: #475569; background: #f1f5f9; padding: 4px 8px; border-radius: 6px;">150 Questions</span>
                            <span style="font-size: 12px; font-weight: 600; color: #475569; background: #f1f5f9; padding: 4px 8px; border-radius: 6px;">3 Hours</span>
                            <span style="font-size: 12px; font-weight: 600; color: #475569; background: #f1f5f9; padding: 4px 8px; border-radius: 6px;">Multiple Choice</span>
            ...
            <div class="format-card" onclick="QuizEngine.startFlow('topic')" style="align-items: flex-start;">
                <div class="format-card-left" style="align-items: flex-start;">
                    ...
                    <div class="format-info" style="width: 100%;">
                        <h3 style="font-size: 18px; margin-bottom: 8px;">National Investigators' Examination (NIE)</h3>
                        <div style="display: flex; gap: 8px; margin-bottom: 0; flex-wrap: wrap;">
...
`;
    ...
    html = html.substring(0, sergeantStart) + newExams + '\n            ' + html.substring(mixedCardStart);
    fs.writeFileSync(filePath, html);
    console.log('Restored exams properly');
} else {
